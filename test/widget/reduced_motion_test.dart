...
void main() {
  testWidgets(
    'disableAnimations renders plain text and never starts a ticker',
    (tester) async {
      await tester.pumpWidget(
        host(TextMorph(value: 'hello'), disableAnimations: true),
      );
      ...
      await tester.pumpWidget(
        host(TextMorph(value: 'hello world'), disableAnimations: true),
      );
